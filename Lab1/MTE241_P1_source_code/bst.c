 ...
 ****************************************************************************/
 ...
 /*
 * Names:
 *   1.  uWaterloo User ID:  dyxlin@uwaterloo.ca
 *   2.  uWaterloo User ID:  chwalter@uwaterloo.ca
 */
...
*               to main.c or bst.c.
*****************************************************************
*  1.Lines 61 and 62 were not tabbed. Easier to read now. 
*  2.Deletion case numbers were swapped to be in incrementing order
*  3.Added line breaks and indents to lines 211 area to improve readability
*  4.Indenting line 93 for easier reading of what the if function entails
*  5.Indenting line 144 for easier reading of what the while loop entails
****************************************************************/
...
*****************************************************************
*  1.Changed line 287 to -= from += to decrement. Found using stepthrough
*  2.Missing additional & symbol on line 195 for && comparator instead of bitwise operator. Found using StepThrough/visual inspection.
*  3. Line 229 Changed from p_parentNode->right = p_currNode->right to p_parentNode->right = p_currNode->left; Found using Variable watching.
*  4. Line 225 dots changed to arrow pointers
****************************************************************/
